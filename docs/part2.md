...
Also, form now on, I'll add the full code of all the files that changed below.  
NOTE: I also put a guard on the signal handlers, as they are not implemented on windows.  
